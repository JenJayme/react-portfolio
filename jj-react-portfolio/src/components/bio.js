...
import { Container, Col, Row, roundedCircle } from 'react-bootstrap';
...
function Bio () {
    return (
        <Container>
            <Row>
                <Col s={1}>
                    <img className="headshot" src="../images/jen-head-shot.png" alt="Jen Jayme photo" />
                </Col>
                <Col s-8><p className="text-justify">
